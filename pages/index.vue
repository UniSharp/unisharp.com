<template lang="pug">
  .index
    ...
    .row.no-gutters
      .col-md-6
        section.introduction.introduction-website
          h2.title
            span 絕佳設計
            span 美觀細膩
          p.content
    ...
    .row.no-gutters
      ...
      .col-md-6.order-md-first
        ...
        section.row.no-gutters.h-md-50
          section.col-6.h-md-100.image.image-employee
          section.col-6.h-md-100.image.image-office
    .row.no-gutters
      .col-md-6
